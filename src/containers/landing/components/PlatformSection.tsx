    ...
    <section id="platform" className="border-b border-border bg-background">
      <div className="container py-20 lg:py-24">
        <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:gap-16">
          <div>
            <p className="text-sm font-semibold uppercase tracking-wide text-brand-cyan">What we do</p>
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              ACSE AI integrates with your existing systems to automate inbound customer requests,
              billing exceptions, and field service orders — reducing manual effort across every
              department.
            </p>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {pillars.map((p) => (
              ...
              >
                ...
                <h3 className="mt-4 font-semibold text-brand-navy dark:text-slate-100">{p.title}</h3>

/**
 * Barrel — keeps feature imports to one line in `index.tsx`.
 */
...
export { default as CustomerList } from '@/containers/copilot/components/CustomerList'
export { default as OtpInput } from '@/containers/copilot/components/OtpInput'
export { default as SlideOver } from '@/containers/copilot/components/SlideOver'
